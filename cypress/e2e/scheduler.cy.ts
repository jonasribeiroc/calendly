describe('Scheduler Page', () => {
    ...
    it('should select a day and display available times', () => {
      ...
      cy.get('[data-testid="13:00"]').should('be.visible').click();
    });
  
    it('should redirect to the schedule event page after selecting a time and go next', () => {
      cy.get('[data-testid="15"]').click();
      cy.get('[data-testid="13:00"]').click();
      cy.get('[data-testid="next-button"]').click();
      cy.url().should('eq', `${Cypress.config().baseUrl}/2025-01-15T13:00:00+00:00?month=2025-01&date=2025-01-15`);
    ...
    it('should redirect to home after successful schedule', () => {
      ...
      cy.fixture('user').then((user) => {
        ...
        cy.url().should('eq', `${Cypress.config().baseUrl}/success?name=Jonas%20Ribeiro&email=jonasribeiroc@gmail.com&date=2025-01-15T13:00:00+00:00`);
